...
type SearchResults struct {
	...
	// Search by tag list results
	// Required: true
	Results []*ManagedResource `json:"results"`
}

// UnmarshalJSON unmarshals this object from a JSON structure
func (m *SearchResults) UnmarshalJSON(raw []byte) error {
...
func (m SearchResults) MarshalJSON() ([]byte, error) {
	var _parts [][]byte
